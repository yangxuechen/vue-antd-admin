...
const cityData2 = {
  ...
  河北省:["石家庄市","唐山市","秦皇岛市","邯郸市","邢台市","保定市","张家口市","承德市","沧州市","廊坊市","衡水市"],"山西省":["太原市","大同市","阳泉市","长治市","晋城市","朔州市","晋中市","运城市","忻州市","临汾市","吕梁市"],
...
export function getCityData(provice){
  let cityArr = [];
  const res = [];
  Object.keys(cityData2).map(p =>{
    if(p == provice){
      cityArr = cityData2[p];
    }
  })
  cityArr.map(city =>{
    res.push({label:city,value:city})
  })
  return res;
}
